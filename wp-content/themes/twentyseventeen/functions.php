...
function twentyseventeen_scripts() {
	...
	// Load the html5 shiv.
	wp_enqueue_script( 'html5', get_theme_file_uri( '/assets/js/script.js' ), array('jquery'), '3.7.3' );
...
// agregar hoja de estilo custom  // agregar hoja de estilo custom // agregar hoja de estilo custom // agregar hoja de estilo custom // agregar hoja de estilo custom
...
function add_css_js_custom_Dark() {
  ...
  wp_enqueue_style('bootstrap-dark-css', get_template_directory_uri() . '/assets/css/bootstrap.css' );
	wp_enqueue_script( 'script-dark-js', get_template_directory_uri() . '/assets/js/script.js', array(), '20160604', true );
}
